...
class VocabulariesControllerTest < ActionController::TestCase
  ...
  test "should create vocabulary" do
    assert_difference('Vocabulary.count') do
      post :create, vocabulary: { example: @vocabulary.example, meaning: @vocabulary.meaning, name: @vocabulary.name, p_symbol: @vocabulary.p_symbol }
    end
  ...
  test "should update vocabulary" do
    patch :update, id: @vocabulary, vocabulary: { example: @vocabulary.example, meaning: @vocabulary.meaning, name: @vocabulary.name, p_symbol: @vocabulary.p_symbol }
    assert_redirected_to vocabulary_path(assigns(:vocabulary))
  end
